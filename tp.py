...
Establecimientos = pd.read_excel("/home/Estudiante/Escritorio/tp labo datos//2022_padron_oficial_establecimientos_educativos.xlsx", skiprows=6, usecols= columnas_ee)
...
elimino = """
            ...
            'Secundario - INET' as 'SecundarioINET', 'SNU', 'SNU - INET' as 'SNUinet'
            FROM df_establecimiento
          """
